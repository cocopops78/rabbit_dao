...
contract sRS is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Token Staked RS Coin", "sRS", 9) ERC20Permit() {
    ...
    /**
        @notice increases sRS supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sRS
